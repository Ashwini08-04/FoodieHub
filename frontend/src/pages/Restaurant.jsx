  ...
  return (
    <main className="restaurant">
      ...
      <div className="restaurant-grid">
        {filteredRestaurants.map((restaurant, index) => <Link to={`/restaurant/${restaurant._id}`} key={restaurant._id} className="restaurant-result" style={{ "--delay": `${index * 70}ms` }}><RestaurantCard {...restaurant} /></Link>)}
      </div>
